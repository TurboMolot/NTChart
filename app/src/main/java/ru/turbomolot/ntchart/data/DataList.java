...
/**
 * DataList is a brand new List implementation which is way faster than ArrayList and LinkedList.
 ...
 * Unlike ArrayList DataList does it dynamically way with creating new node so old data does NOT have to be moved to another array.
 * You can think that DataList is dynamic version of ArrayList.
 * <br>
 ...
 */
public class DataList<T> extends AbstractList<T> implements List<T>, Cloneable, Serializable {
    ...
    private void checkNonNull(Object el) {
        if(el == null) throw new NullPointerException();
    }
    public DataList(Collection<? extends T> c) {
    ...
    private class Itr implements Iterator<T> {
        ...
        public void remove() {
            ...
            try {
                DataList.this.remove(lastReturn);
    ...
    private class ListItr extends Itr implements ListIterator<T> {
        ...
        public void set(T t) {
            ...
            try {
                DataList.this.set(lastReturn, t);
            } catch (IndexOutOfBoundsException e) {
                throw new ConcurrentModificationException();
            }
        }
    ...
    public Object clone() {
        ...
        try {
            DataList<T> clone = (DataList<T>) super.clone();
